                                ...
                                <Stack direction='row' spacing={10}>
                                    <Stack direction='row'>
                                        ...
                                        <Stack direction='column'>
                                            <Typography sx={{ marginLeft: 2, fontWeight: 'bold', fontSize: '18px' }}>Viezh Robert</Typography>
                                            <Typography sx={{ marginLeft: 2, fontSize: '14px' }}>Warsaw, Poland</Typography>
                                        </Stack>
                                    </Stack>
                                    <Stack direction='row' spacing={2} sx={{ alignItems: 'center', paddingLeft: 5 }}>
                                        <Typography sx={{ fontSize: '15px' }}>4.5</Typography>
                                        <StarIcon fontSize='small' sx={{ color: '#FEA250' }} />

                                    </Stack>
                                </Stack>
                                <Typography sx={{
                                    lineHeight: '30px', fontSize: '14px'
                            ...
                            <Stack direction='column' spacing={5} mb={3.8}>
                                <Stack direction='row' spacing={10}>
                                    <Stack direction='row'>
                                        ...
                                        <Stack direction='column'>
                                            <Typography sx={{ marginLeft: 2, fontWeight: 'bold', fontSize: '18px' }}>Yessica Christy</Typography>
                                            <Typography sx={{ marginLeft: 2, fontSize: '14px' }}>Shanxi, China</Typography>
                                        </Stack>
                                    </Stack>
                            ...
                            <Stack direction='column' spacing={5}>
                                <Stack direction='row' spacing={10}>
                                    <Stack direction='row'>
                                        ...
                                        <Stack direction='column'>
                                            <Typography sx={{ marginLeft: 2, fontWeight: 'bold', fontSize: '18px' }}>Kim Young Jou</Typography>
                                            <Typography sx={{ marginLeft: 2, fontSize: '14px' }}>Seoul, South Korea</Typography>
                                        </Stack>
                                    </Stack>
                                    <Stack direction='row' spacing={1} sx={{ alignItems: 'center', paddingLeft: 5 }}>
                                        <Typography sx={{ fontSize: '15px' }}>4.5</Typography>
